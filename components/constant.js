...
const COMPUTING_FATAL_ERROR = "저희 서버에 문제가 발생한 것 같습니다. 오류를 yoonhero06@naver.com으로 제보해주세요..."
const NON_INPUT_ERROR = "무언가를 입력해 주시겠어요?"
const NON_OUTPUT_ERROR = "자모가 아무 말도 안했네요.."
...
export {COMPUTING_LIMITATION_ERROR, COMPUTING_FATAL_ERROR, MSG_EVENT, LOGIN_EVENT, NON_INPUT_ERROR, USER, COMPUTER, LOGIN_TRIGGER_NUM, AB_MODEL_TEST_EVENT, RANK_RES_EVENT, SINGLE_MESSAGE, MULTIPLE_MESSAGES, MOJA_TITLE, MOJA_DESC, SHARED_CONTENT_EVENT, NON_OUTPUT_ERROR}
